const en = {
    ...
    forwardingRulesDesc: 'Rule-based forwarding uses a regular expression to match the full recipient address before forwarding',
    ruleEmailsInputDesc: 'Enter a regular expression, e.g. ^admin@example\\.com$',
    invalidRuleEmailRegexMsg: 'Invalid regular expression',
